#!/usr/bin/env python3
"""Find the fastest safe intermediate batch on two H100 SXM GPUs."""
...
def main() -> None:
    ...
    def progress(message: str) -> None:
        if rank == 0:
            print(
                f"minerva-h100-intermediate | {message} | "
    ...
    if rank == 0:
        print(
            "minerva-h100-intermediate | start ranks=2 candidates=6 "
            "global_tokens=5120,6144,7168 buckets_mib=25,250 "
    ...
    if rank == 0:
        ...
        print(
            "minerva-h100-intermediate | complete selected={candidate} "
