#!/usr/bin/env python3
"""Create the committed Foscolo snapshot from the reviewed local audit."""
...
def main() -> None:
    snapshot_path = ROOT / "data/metadata/wikisource_snapshots/ws_foscolo_sonetti.json"
    snapshot = create_sonnet_source_snapshot(
        audit_report_path=ROOT / "data/local/sonnet_audits/ws_foscolo_sonetti_probe.json",
