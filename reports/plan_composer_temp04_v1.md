...
| Poems scheme-valid | n/a | 0.6734 |
| Accepted lines | n/a | 7.327 |
| Failed lines | n/a | 1.147 |
| Composed pipeline rate | 0.0000 | 0.6250 |
...
- Autonomous scheme validity 0.6250 against baseline 0.0000 and gate 0.30.
- Accepted-line gap +7.327 (minimum -0.5).
