...
| Poems scheme-valid | n/a | 0.7318 |
| Accepted lines | n/a | 7.323 |
| Failed lines | n/a | 0.930 |
| Composed pipeline rate | 0.0000 | 0.6792 |

## Judge panel (composed poems)

| Judge | Condition | Mean | Separation |
|---|---|---:|---:|
| opencode-go/glm-5.2 | stage2_plan_sft | 3.075 | 1.275 |
| opencode-go/qwen3.6-plus | stage2_plan_sft | 2.825 | 1.375 |

## Pre-registered reading

- Result: SELF_PLAY_SIGNAL
- Autonomous scheme validity 0.6792 against baseline 0.0000 and gate 0.30.
- Accepted-line gap +7.323 (minimum -0.5).
