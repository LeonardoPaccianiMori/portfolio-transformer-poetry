...
| Accepted lines | 5.708 | 6.950 |
| Failed lines | 5.342 | 1.279 |
| Uncertain lines | 2.950 | 5.771 |
| 4+4+3+3 stanza pattern | 0.5750 | 0.9792 |
| Rhyme score | 0.9133 | 0.5250 |

## Coherence proxies

| Metric | Baseline | RFT |
|---|---:|---:|
| type_token_ratio | 0.6064 | 0.6386 |
| repeated_line_ratio | 0.0003 | 0.0003 |
| repeated_bigram_ratio | 0.0649 | 0.0596 |
| final_word_repetition | 0.2372 | 0.0345 |
