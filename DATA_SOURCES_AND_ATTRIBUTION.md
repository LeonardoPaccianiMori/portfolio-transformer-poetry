...
| Combined historical Italian pretraining corpus, v2 | [`data/processed/pretraining_historical_italian_v2/`](data/processed/pretraining_historical_italian_v2/) | [`data/metadata/pretraining_historical_italian_v2_mixture.json`](data/metadata/pretraining_historical_italian_v2_mixture.json), [`docs/pretraining_mixture_policy.md`](docs/pretraining_mixture_policy.md), its [`16k BPE tokenizer`](data/metadata/pretraining_tokenizers/pretraining_historical_italian_v2_bpe_16000.json), and [`tokenizer report`](reports/pretraining_historical_italian_v2_bpe_16000_report.json) |
