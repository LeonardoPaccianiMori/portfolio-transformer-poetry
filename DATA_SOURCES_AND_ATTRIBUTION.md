...
| Biblioteca Italiana historical/Ottocento candidates | [`data/metadata/bibit_catalog_origins_through_ottocento_v1.json`](data/metadata/bibit_catalog_origins_through_ottocento_v1.json) and [`data/metadata/bibit_historical_composition_decisions.csv`](data/metadata/bibit_historical_composition_decisions.csv) | [`data/metadata/bibit_historical_attribution.md`](data/metadata/bibit_historical_attribution.md) and the [`composition audit`](reports/bibit_historical_composition_audit.md). This is a non-commercial lineage requiring Biblioteca Italiana citation and work-level TEI attribution; composition approval is not text activation. |
