...
| Biblioteca Italiana historical, non-sonnet poetry, sonnet, and Ottocento candidates | [`data/metadata/bibit_catalog_origins_through_ottocento_v1.json`](data/metadata/bibit_catalog_origins_through_ottocento_v1.json), [`data/metadata/bibit_historical_composition_decisions.csv`](data/metadata/bibit_historical_composition_decisions.csv), [`data/metadata/bibit_tei_audit_records.csv`](data/metadata/bibit_tei_audit_records.csv), and [`data/metadata/bibit_sonnet_candidates_audit.csv`](data/metadata/bibit_sonnet_candidates_audit.csv) | [`data/metadata/bibit_historical_attribution.md`](data/metadata/bibit_historical_attribution.md), the [`composition audit`](reports/bibit_historical_composition_audit.md), and the [`full TEI role audit`](reports/bibit_tei_role_audit.md). This is a non-commercial lineage requiring Biblioteca Italiana citation and work-level TEI attribution; the full audit is complete, but review-blocked records and poems are not active training data. |
